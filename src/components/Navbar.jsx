...
export default function Navbar (){
    ...
    const changeLanguage = (lng) => {
        ...
        dropdownRef.current.removeAttribute("open"); // chiude il <details>
        }
    };
    useEffect(() => {
        ...
        <nav className="navbar bg-[#e6e6e6] shadow-sm">
            <div className="navbar-start">
                <div className="dropdown">
                    ...
                    <ul className="menu menu-sm dropdown-content rounded-box z-5 mt-3 w-52 p-2 shadow bg-white" tabIndex={0}>
                        ...
                        <li>
                            <details className="dropdown block lg:hidden" ref={dropdownRef}>
            ...
            <div className="navbar-end">
                <div className="flex justify-center items-center gap-5">
                    <details className="dropdown hidden lg:block" ref={dropdownRef}>
